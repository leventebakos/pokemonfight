...
public class PlayerBattle {
    ...
    private Player winnerOfFirstPokemonsClash;
    ...
    public Player battle() {
        ...
        for (int i = 0; i < NUMBER_OF_POKEMONS; i++) {
            ...
            LOGGER.warn("********{} selects level {} {}, {} selects level {} {}:", player1.getName(), player1Pokemon.getLevel(),
                    player1Pokemon.getPokemon().getName(), player2.getName(), player2Pokemon.getLevel(), player2Pokemon.getPokemon().getName());
    ...
    private void increaseWinnersScore(UniquePokemon winningPokemon, UniquePokemon player1Pokemon, UniquePokemon player2Pokemon) {
        if (winningPokemon.equals(player1Pokemon)) {
            player1Score++;
        ...
        LOGGER.warn("************The winner of this battle is: {}, the standing is: {}-{}: {}-{}!", winningPokemon.getPokemon().getName(),
                player1.getName(), player2.getName(), player1Score, player2Score);
    }
